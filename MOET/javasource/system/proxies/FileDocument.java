...
public class FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("SAML20.IdPMetadata", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("SAML20.KeyStore", mendixObject.getType()))
			return saml20.proxies.KeyStore.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("Confirmation.PdfFiles", mendixObject.getType()))
			return confirmation.proxies.PdfFiles.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("SAML20.SAMLRequest", mendixObject.getType()))
			return saml20.proxies.SAMLRequest.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("SAML20.SAMLResponse", mendixObject.getType()))
			return saml20.proxies.SAMLResponse.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("SAML20.SPMetadata", mendixObject.getType()))
			return saml20.proxies.SPMetadata.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("SAML20.X509Certificate", mendixObject.getType()))

...
public class Constants {
    ...
    public final String getLogoutPage() {
        ...
        String indexpage = this.SSO_PATH, indexconfig = StringUtils.trim(constant);
    ...
    public static final String getLandingPage() {
        Object constant = saml20.proxies.constants.Constants.getSSOLandingPage();
        String indexpage = "index.html", indexconfig = StringUtils.trim(constant.toString());

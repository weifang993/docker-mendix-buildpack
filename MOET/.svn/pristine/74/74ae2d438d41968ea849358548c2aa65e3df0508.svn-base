...
public class Account extends system.proxies.User
{
	...
	/**
	 * @return value of CpcID
	 */
	public final java.lang.String getCpcID()
	{
		return getCpcID(getContext());
	}
	 ...
	 * @return value of CpcID
	 */
	public final java.lang.String getCpcID(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (java.lang.String) getMendixObject().getValue(context, MemberNames.CpcID.toString());
	}
	 ...
	 * @param cpcid
	 */
	public final void setCpcID(java.lang.String cpcid)
	{
		setCpcID(getContext(), cpcid);
	}
	 ...
	 * @param cpcid
	 */
	public final void setCpcID(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String cpcid)
	{
		getMendixObject().setValue(context, MemberNames.CpcID.toString(), cpcid);
	}

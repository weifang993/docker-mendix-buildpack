...
public class LoginHandler extends SAMLHandler {
	...
	public void handleRequest( SAMLRequestContext context ) throws SAMLException {
		...
		if (continuation != null && !continuation.equals("")) {
			...
			_logNode.trace("Continuation parameter found, relayState is now: " + relayState);
		}
		...
		org.opensaml.saml2.metadata.Endpoint signonLocation = metadata.findLoginEndpoint(Constants.getBindingURIs());

...
public class IdpMetadata extends IMetadata {
    ...
    public static IdpMetadata getInstance() throws SAMLException, ConfigurationException {
        if (instance == null)
    ...
    public IdpMetadata updateConfiguration(IContext context, List<IMendixObject> ssoConfigurationList) throws SAMLException, ConfigurationException {
    ...
    public static EntityDescriptor getIdpEntityDescriptor(IContext context, IMendixObject ssoConfiguration) throws SAMLException, ConfigurationException {
        ...
        try {
            ...
            if (idpMetaDataId == null)
                throw new ConfigurationException("No IdP Metadata file located");
            ...
            if (entityDescriptorId == null)
                throw new ConfigurationException("No entity descriptor was selected for the SSO Configuration");
        ...
        private Metadata(IMendixObject ssoConfiguration, EntityDescriptor entityDescriptor, String protocol) throws SAMLException {
            ...
            for (KeyDescriptor keyDescriptor : this.idpSSODescriptor.getKeyDescriptors()) {
                ...
                for (X509Data x509Data : keyDescriptor.getKeyInfo().getX509Datas()) {
                    List<org.opensaml.xml.signature.X509Certificate> certList = x509Data.getX509Certificates();
                    for (org.opensaml.xml.signature.X509Certificate certificate : certList) {
                        try {
                            X509Certificate cert = SecurityHelper.buildJavaX509Cert(certificate.getValue());

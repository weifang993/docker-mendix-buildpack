...
public class SecurityHelper {
    ...
    private static X509Certificate generateCertificate(EncryptionMethod encrMethod, Credential credential, String entityId) throws Exception {
        ...
        try (ByteArrayInputStream bIn = new ByteArrayInputStream(credential.getPublicKey().getEncoded());
        ...
        gen.addExtension(Extension.subjectKeyIdentifier, false, new JcaX509ExtensionUtils().createSubjectKeyIdentifier(credential.getPublicKey()));
        gen.addExtension(Extension.authorityKeyIdentifier, false, new JcaX509ExtensionUtils().createAuthorityKeyIdentifier(credential.getPublicKey()));
        ...
        ContentSigner sigGen = new JcaContentSignerBuilder((encrMethod != null ? encrMethod.toString() : EncryptionMethod.SHA1withRSA.toString()))
                .setProvider("BC").build(credential.getPrivateKey());
    ...
    protected static KeyStore prepareKeystore(IContext context, IMendixObject spMetadataConfiguration, EncryptionMethod encryptionMethod, EncryptionKeyLength encryptionKeyLength, boolean createNewKeystore) throws SAMLException {
        String entityId = (String) spMetadataConfiguration.getValue(context, SPMetadata.MemberNames.EntityID.toString());
        ...
        try {
                ...
                if (keyStoreId != null) {
                    ...
                    if (!createNewKeystore
                        ...
                        if (ksCert == null) {
                            ...
                            cred.setPublicKey(ksCert.getPublicKey());
            ...
            X509Certificate cert = SecurityHelper.generateCertificate(encryptionMethod, cred,

...
RUN mkdir -p /opt/mendix/buildpack /opt/mendix/build &&\
   ...
   wget --no-check-certificate -qO- https://github.com/mendix/cf-mendix-buildpack/archive/${CF_BUILDPACK}.tar.gz | tar xvz -C /opt/mendix/buildpack --strip-components 1 &&\
